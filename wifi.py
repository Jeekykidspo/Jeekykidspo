...
# Fonction pour créer un hotspot Wi-Fi
def create_wifi_hotspot():
    # Crée un hotspot Wi-Fi avec les informations de connexion
    wifi.create_wifi_hotspot(wifi_name, password)

# Fonction pour démarrer le hotspot Wi-Fi
def start_wifi_hotspot():
    # Démarre le hotspot Wi-Fi
    wifi.start_wifi_hotspot()

# Démarre le hotspot Wi-Fi
start_wifi_hotspot()

print(Fore.GREEN + "Hotspot Wi-Fi démarré avec succès !")
